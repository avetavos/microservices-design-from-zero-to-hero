...
> 💡 ตัวอย่างจากของจริง
>
> **Amazon:** ส่วนหนึ่งของ Bezos API mandate (2002) คือให้แต่ละทีมเป็นเจ้าของ capability ของตัวเองแบบ end-to-end ผ่าน service interface — เป็นการแบ่งงานที่ยึดตามสิ่งที่ธุรกิจทำ (catalog, ordering, payment, fulfillment) ไม่ใช่ตามชั้นทางเทคนิค ทำให้ scale ทีมและ service ไปพร้อมกันได้ ([Nordic APIs: The Bezos API Mandate](https://nordicapis.com/the-bezos-api-mandate-amazons-manifesto-for-externalization/))
>
> **แนวปฏิบัติทั่วไปในบริษัท ride-hailing/delivery:** มักแบ่ง service ตาม capability หลักของธุรกิจ เช่น rider matching, pricing, payment, driver management โดยแต่ละ capability deploy และ scale อิสระจากกัน — รูปแบบทั่วไปที่สอดคล้องกับหลักการ decompose-by-capability ไม่ได้อ้างอิงระบบภายในของบริษัทใดบริษัทหนึ่งโดยเฉพาะ
