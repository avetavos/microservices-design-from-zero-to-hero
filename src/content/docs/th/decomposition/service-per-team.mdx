...
> 💡 ตัวอย่างจากของจริง
>
> **Spotify:** เผยแพร่ "Spotify Engineering Culture" ที่อธิบาย "Squad" model — squad แต่ละทีมเป็นเจ้าของส่วนหนึ่งของผลิตภัณฑ์แบบ full-stack และ deploy ได้อิสระ แต่ Spotify เองก็เขียนกำกับไว้ชัดเจนว่า "this is a journey in progress, not a journey completed" และภาพที่เล่าอาจไม่ตรงกับทุก squad ทุกช่วงเวลา ([Spotify Engineering: Spotify Engineering Culture](https://engineering.atspotify.com/2014/03/spotify-engineering-culture-part-1/))
>
> **Amazon:** Werner Vogels (CTO) พูดไว้ใน ACM Queue ปี 2006 ว่า "You build it, you run it" — ทีมที่สร้าง service คือทีมที่ดูแล operation ของมันเอง ทำให้ทีมได้รับ feedback จากลูกค้าโดยตรงและใส่ใจ reliability มากขึ้น ([ACM Queue: A Conversation with Werner Vogels](https://queue.acm.org/detail.cfm?id=1142065))
