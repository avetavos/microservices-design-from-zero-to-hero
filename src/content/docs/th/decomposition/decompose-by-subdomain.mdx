...
> 💡 ตัวอย่างจากของจริง
>
> **Zalando:** engineering blog ของ Zalando เผยแพร่บทความหลายชิ้นเกี่ยวกับการใช้ Domain-Driven Design ร่วมกับ microservices เพื่อแบ่งแพลตฟอร์ม e-commerce ขนาดใหญ่ออกเป็น bounded context ที่มี Ubiquitous Language ของตัวเอง ([Zalando Engineering Blog: Microservices](https://engineering.zalando.com/tags/microservices.html))
>
> **หลักการทั่วไปที่แพลตฟอร์ม e-commerce มักใช้:** แบ่ง subdomain ตามบทบาทใน DDD ได้แก่ core domain (จุดที่สร้างความได้เปรียบทางธุรกิจ เช่น checkout, pricing), supporting domain (เช่น inventory, shipping) และ generic domain (เช่น authentication, notification ที่มักซื้อสำเร็จรูปได้) — เป็นกรอบคิดทั่วไปจากตำรา DDD ไม่ได้อ้างอิงการแบ่งงานจริงของบริษัทใดบริษัทหนึ่งโดยเฉพาะ
