...
> 💡 ตัวอย่างจากของจริง
>
> **Chris Richardson (microservices.io):** สร้าง microservices pattern language catalog ที่ patterns เชื่อมโยงกันเป็นโซ่ — แก้ปัญหาหนึ่งมักเปิดปัญหาถัดไปที่ต้องใช้ pattern ใหม่มาแก้ ([microservices.io: Pattern language](https://microservices.io/patterns/index.html))
>
> **Martin Fowler & James Lewis / Sam Newman:** บทความ "Microservices" (2014) ของ Fowler กับ Lewis เป็นตัวนิยาม architectural style ที่อุตสาหกรรมยึดถือ ([martinfowler.com: Microservices](https://martinfowler.com/articles/microservices.html)) ส่วนหนังสือ "Building Microservices" ของ Sam Newman เป็น reference เชิงปฏิบัติที่สำคัญของอุตสาหกรรม
