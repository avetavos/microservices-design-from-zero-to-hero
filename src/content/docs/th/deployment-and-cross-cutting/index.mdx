...
description: 'พอมี service หลายตัว การเขียนขึ้นมาไม่ใช่ส่วนที่ยากอีกต่อไป การ package การรัน และการดูแลต่างหากที่ยาก โมดูลนี้ครอบคลุมวิธีส่งมอบ service และวิธีให้ทุก service ได้ baseline เดียวกันทั้งด้าน networking, config และความสามารถในการดูแล'
sidebar:
  order: 1
---
...
- [Service per Container](/microservices/th/deployment-and-cross-cutting/service-per-container/) — เริ่มจากตัวนี้ เพราะเป็นวิธีมาตรฐานที่ service รันกันในปัจจุบัน
- [Externalized Configuration](/microservices/th/deployment-and-cross-cutting/externalized-configuration/) — pattern ที่ทำให้ artifact ที่ build แล้วเพียงชิ้นเดียวรันได้ทุกที่
...
export const quizIndex = [
  ...
  {
    q: 'โมดูลนี้จัดกลุ่ม pattern อย่างไร',
    options: [
      'ตามภาษาโปรแกรม',
