...
- [Saga](/microservices/th/data-management/saga/) — พึ่งพาการ publish event ที่เชื่อถือได้ในทุกขั้นตอน
- [Event Sourcing](/microservices/th/data-management/event-sourcing/) — อีกวิธีหนึ่งในการทำให้ event เป็นการเขียนเดียวกันกับการเปลี่ยนแปลง state
...
export const quizIndex = [
  ...
  },
  {
    ...
    options: [
      ...
      'การเปลี่ยนแปลงถูกบันทึกไว้แล้วแต่ระบบส่วนที่เหลือไม่เคยรับรู้ กลายเป็น lost event',
  ...
  },
  {
    ...
    options: [
      ...
      'ทำให้ข้อความเป็นส่วนหนึ่งของ local transaction เดียวกับการเปลี่ยนแปลงทางธุรกิจ แล้วแยกการส่งออกไปเป็นขั้นตอนที่ retry ได้',
