...
> 💡 ตัวอย่างจากของจริง
>
> **Amazon:** ส่วนหนึ่งของ Bezos API mandate (2002) คือห้าม direct database access ข้ามทีมโดยเด็ดขาด แต่ละทีมเลือกและดูแล datastore ของตัวเอง ([Nordic APIs: The Bezos API Mandate](https://nordicapis.com/the-bezos-api-mandate-amazons-manifesto-for-externalization/))
>
> **Netflix:** ใช้ polyglot persistence ตามลักษณะงาน — Cassandra สำหรับข้อมูล viewing history ที่ต้องรับ write throughput สูงและกระจายหลายภูมิภาค, MySQL สำหรับข้อมูล billing/subscription ที่ต้องการ ACID, และ Elasticsearch สำหรับ search/analytics ซึ่งเป็นแนวทางที่บทความหลายชิ้นบน Netflix TechBlog บันทึกไว้ (เช่นบทความชุด viewing-history data platform) — ดู [netflixtechblog.com](https://netflixtechblog.com/) สำหรับรายละเอียดเชิงลึกของแต่ละระบบ
