...
> 💡 ตัวอย่างจากของจริง
>
> **Stripe:** บันทึก event และ API call ที่เกี่ยวกับบัญชีไว้ให้ดูผ่าน Dashboard เพื่อใช้ตรวจสอบ dispute resolution และ compliance ([Stripe Docs: Events](https://docs.stripe.com/api/events))
>
> **AWS CloudTrail:** บันทึก API call เกือบทั้งหมดใน AWS account เป็น event log ที่ integrate กับ S3 สำหรับ long-term retention ได้ และเปิด log file integrity validation เพื่อตรวจจับการดัดแปลงได้ ([AWS Docs: AWS CloudTrail concepts](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-concepts.html))
