...
> 💡 ตัวอย่างจากของจริง
>
> **Netflix:** สร้าง Atlas เป็น in-house time-series metric system — ปี 2014 เก็บอยู่ที่ราว 1.2 พันล้าน metric และยังโตต่อเนื่อง ระบบ fetch/graph ข้อมูลได้หลายพันล้าน datapoint ต่อวินาที ([Netflix TechBlog: Introducing Atlas](https://techblog.netflix.com/2014/12/introducing-atlas-netflixs-primary.html))
>
> **Airbnb:** ใช้แนวทาง SLO-based alerting ตามแบบ Google SRE — ตั้ง alert เมื่อ error budget กำลังจะหมด แทนที่จะ alert ทุกครั้งที่ metric ตัวใดตัวหนึ่งข้าม threshold เดี่ยว ๆ ([Google SRE Workbook: Alerting on SLOs](https://sre.google/workbook/alerting-on-slos/))
