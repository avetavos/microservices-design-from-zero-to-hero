...
> 💡 ตัวอย่างจากของจริง
>
> **Uber:** เป็นหนึ่งใน deployment ของ Apache Kafka ที่ใหญ่ที่สุดในโลก — GPS location ของ driver ไหลเข้า Kafka เป็น event stream แล้วขับเคลื่อนทั้ง dynamic pricing และการคำนวณ ETA แบบเกือบ real-time ทำให้แต่ละ consumer (pricing, ETA, map) scale แยกจากกันได้ ([Uber Engineering Blog: Kafka](https://www.uber.com/en-US/blog/kafka/))
>
> **LinkedIn (ผู้สร้าง Kafka):** สร้าง Kafka เพื่อแก้ปัญหา messaging ภายในตัวเอง ปัจจุบันมี Kafka cluster กว่า 100 ตัวและ broker กว่า 4,000 เครื่อง ประมวลผลกว่า 7 ล้านล้าน (trillion) message ต่อวัน ([LinkedIn Engineering: How LinkedIn customizes Apache Kafka for 7 trillion messages per day](https://www.linkedin.com/blog/engineering/open-source/apache-kafka-trillion-messages))
