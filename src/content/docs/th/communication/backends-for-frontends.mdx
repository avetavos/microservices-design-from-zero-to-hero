...
> 💡 ตัวอย่างจากของจริง
>
> **SoundCloud:** Phil Calçado เผยแพร่บทความบัญญัติคำว่า "Backend for Frontend" ในเดือนกันยายน 2015 จากประสบการณ์ตรงที่ SoundCloud ที่มี backend เฉพาะสำหรับแต่ละ client experience แทนที่จะใช้ general-purpose API เดียว ([Phil Calçado: The Back-end for Front-end Pattern (BFF)](https://philcalcado.com/2015/09/18/the_back_end_for_front_end_pattern_bff.html))
>
> **Netflix:** ปรับ API ให้เหมาะกับแต่ละประเภทอุปกรณ์มาตั้งแต่ก่อนคำว่า BFF จะถูกบัญญัติ — บทความปี 2013 ของ Netflix TechBlog อธิบายการ optimize response ให้เข้ากับ constraint ของแต่ละ device เช่น Smart TV, มือถือ และเบราว์เซอร์ ซึ่งเป็นแนวคิดเดียวกับที่ BFF ให้ชื่ออย่างเป็นทางการในภายหลัง ([Netflix TechBlog: Optimizing the Netflix API](https://netflixtechblog.com/optimizing-the-netflix-api-5c9ac715cf19))
