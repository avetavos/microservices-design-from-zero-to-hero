...
- [Circuit Breaker](/microservices/en/reliability/circuit-breaker/) — start here; it is the pattern that stops a hang from becoming an outage.
- [Retry and Timeout](/microservices/en/reliability/retry-and-timeout/) — the per-call discipline a breaker is built on.
