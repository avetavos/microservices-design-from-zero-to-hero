...
- [Decompose by Business Capability](/microservices/en/decomposition/decompose-by-business-capability/) — the most common starting strategy.
- [Decompose by Subdomain](/microservices/en/decomposition/decompose-by-subdomain/) — the Domain-Driven Design path to boundaries.
