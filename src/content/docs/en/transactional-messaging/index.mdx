...
- [Saga](/microservices/en/data-management/saga/) — depends on reliable event publishing for every step.
- [Event Sourcing](/microservices/en/data-management/event-sourcing/) — another way to make the event the same write as the state change.
