...
- [Monolith vs Microservices](/microservices/en/intro-and-principles/monolith-vs-microservices/) — what you are moving away from, and why it is not the enemy.
- [The Pattern Language](/microservices/en/intro-and-principles/the-pattern-language/) — how every pattern in this course connects.
- [Data Management](/microservices/en/data-management/) — the module where "each service owns its data" gets hard.
