...
- [Remote Procedure Invocation](/microservices/en/communication/remote-procedure-invocation/) — start here, the simplest style.
- [Messaging](/microservices/en/communication/messaging/) — the asynchronous alternative.
