...
- [Database per Service](/microservices/en/data-management/database-per-service/) — start here, it is the foundation.
- [Saga](/microservices/en/data-management/saga/) — the showcase pattern for cross-service writes.
