...
- [Health Check API](/microservices/en/observability/health-check-api/) — start here; it is the simplest signal and the one your platform depends on first.
- [Distributed Tracing](/microservices/en/observability/distributed-tracing/) — the pattern that most directly replaces "read one stack trace" in a distributed world.
